...
bool operator==(const ::xf_mic_asr_offline::Set_Major_Mic_srvResponse_<ContainerAllocator1> & lhs, const ::xf_mic_asr_offline::Set_Major_Mic_srvResponse_<ContainerAllocator2> & rhs)
{

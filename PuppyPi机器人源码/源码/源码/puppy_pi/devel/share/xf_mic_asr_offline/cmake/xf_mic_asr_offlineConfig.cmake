...
if("TRUE" STREQUAL "TRUE")
  set(xf_mic_asr_offline_SOURCE_PREFIX /home/pi/puppy_pi/src/xf_mic_asr_offline)
  set(xf_mic_asr_offline_DEVEL_PREFIX /home/pi/puppy_pi/devel)
  ...
  set(xf_mic_asr_offline_INSTALL_PREFIX /home/pi/puppy_pi/install)
...
if(NOT "/home/pi/puppy_pi/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'xf_mic_asr_offline' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/puppy_pi/src/xf_mic_asr_offline/${idir}'.  ${_report}")
    endif()

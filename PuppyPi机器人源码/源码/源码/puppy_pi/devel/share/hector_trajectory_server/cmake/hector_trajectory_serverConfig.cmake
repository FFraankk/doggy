...
if("TRUE" STREQUAL "TRUE")
  set(hector_trajectory_server_SOURCE_PREFIX /home/pi/puppy_pi/src/third_party/hector_slam-devel/hector_trajectory_server)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_trajectory_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/puppy_pi/src/third_party/hector_slam-devel/hector_trajectory_server/${idir}'.  ${_report}")
    endif()
